...
public class UpdateAccount {
    ...
    public Parent getView() {
        ...
        //BUTTONS UPDATECURSIST AND UPDATEEMPLOYEE
        Button updateCursist = new Button("Update cursist");
        Button updateEmployee = new Button("Update employee");

        //BUTTONS LOCATION
        layout.setLeft(updateCursist);
        layout.setRight(updateEmployee);

        updateCursist.setTranslateY(200);
        updateEmployee.setTranslateY(200);

        updateCursist.setTranslateX(200);
        updateEmployee.setTranslateX(-200);

//VBOX FOR BUTTON LEFT
        VBox leftCenter = new VBox();
        leftCenter.getChildren().addAll(updateCursist);

//VBOX FOR BUTTON RIGHT
        VBox rightCenter = new VBox();
        rightCenter.getChildren().addAll(updateEmployee);
//LAYOUT PLACE BUTTONS LEFT AND RIGHT
        layout.setLeft(leftCenter);
        layout.setRight(rightCenter);

        //BUTTON EVENT UPDATE CURSIST
        //WIP
        //BUTTON EVENT UPDATE EMPLOYEE
